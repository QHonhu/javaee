...
import packclass.Orderlist;
import packclass.Persion;

public interface MybatisDao {
	@Select("select * from person")
	public List<Persion> getBuyerInfo();
	
	
	@Select("select * from person where userName=#{name}")
	public Persion getBuyerInfoByName(String name);
	...
	public List<packclass.ProductList> getBoughtList();
	...
	public packclass.Product getProductes(int id);
	...
	public List<Orderlist> getBylistInfo();
	...
	public packclass.ProductList getBoughtListById(@Param("pid")int pid);
	@Results({
		@Result(property="buyTime",column="time"),
	})
